...
MinhaList.mostraUsuario(); // Funções do ES6

var arr = [1, 3, 4, 5, 8, 9]; // Função map -
...
console.log(sum); // Função filter - usada para filtrar o array

var filter = arr.filter(function () {
  return item % 2 === 0;
});
console.log(filter); // Find - verificar se existe a informação dentro do array

var find = arr.find(function () {
  return item === 4;
});
console.log(find);
